...
def negSamplingLossAndGradient(
    ...
    gradCenterVec = (sigmoidOutsideCenter - 1) * outsideWordVec - (
        sigmoidSamplesCenter - 1
    ).T @ samplesWordVecs
    ...
    gradOutsideVecs[unique, :] = (
        -((sigmoidUniqueSamplesCenter - 1) * counts)[:, None] * centerWordVec[None, :]
    )
...
def skipgram(
    ...
    for outsideWordIdx in outsideWordIdxs:
        dLoss, dGradCenterVec, dGradOutsideVectors = word2vecLossAndGradient(
